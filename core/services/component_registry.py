...
class ComponentInfo:
    ...
    def __init__(self, guid: str, name: str, icon_glyph: str = "", description: str = ""):
        self.guid = guid
        self.name = name
...
class ComponentRegistryService(QObject):
    ...
    def _register_builtin_components(self):
        ...
        self.registered_components[schedule_component_info.guid] = schedule_component_info
        ...
        self.registered_components[countdown_component_info.guid] = countdown_component_info
        self.registered_settings[countdown_component_info.guid] = countdown_component_info
        ...
        self.registered_components[separator_component_info.guid] = separator_component_info
        self.registered_settings[separator_component_info.guid] = separator_component_info
...
if __name__ == "__main__":
    ...
    # 测试创建组件实例
    try:
        clock_instance = create_component_instance("9E1AF71D-8F77-4B21-A342-448787104DD9")
        if clock_instance:
            print("✓ 时钟组件实例创建成功")
        else:
            print("✗ 时钟组件实例创建失败")
