...
from core.models.component_settings.group_component_settings import (
    GroupComponentSettings,
)
    ...
    def update_content(self):
        ...
        if self.settings.border_color:
            self.group_frame.setStyleSheet(
                f"QFrame#groupFrame {{ border: 1px solid {self.settings.border_color}; }}"
            )
        else:
            self.group_frame.setStyleSheet("")
