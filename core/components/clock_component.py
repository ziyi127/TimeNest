...
from core.models.component_settings.clock_component_settings import (
    ClockComponentSettings,
)
...
class ClockComponent(QWidget):
    ...
    def __init__(
        self,
        lessons_service: Optional[Any] = None,
        exact_time_service: Optional[Any] = None,
    ...
    def init_ui(self):
        ...
        self.main_time_display.setAlignment(
