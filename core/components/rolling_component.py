...
from core.models.component_settings.rolling_component_settings import (
    RollingComponentSettings,
)
...
class RollingComponent(QWidget):
    ...
    def update_content(self):
        ...
        # 根据设置更新滚动文本
        self.scroll_texts = (
            self.settings.scroll_texts.copy() if self.settings.scroll_texts else []
        )
